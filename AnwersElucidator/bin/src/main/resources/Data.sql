...
insert into Questions(fk_uname,category,title,description) values('Sameer1','Java1','Q1','Desc1');
insert into Questions(fk_uname,category,title,description) values('Sameer1','Python','Q25','Desc55');
insert into Questions(fk_uname,category,title,description) values('Shubham1','Java2','Q2','Desc2');
insert into Questions(fk_uname,category,title,description) values('Shruti1','Java3','Q3','Desc3');
