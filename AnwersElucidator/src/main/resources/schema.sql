...
create table Questions(fk_uname varchar(30), qid integer auto_increment not null, category varchar(10), 
...
create table Solutions(fk_uname varchar(30), fk_qid integer, sid integer auto_increment NOT NULL, 
    ...
    primary key(sid), 
    foreign key(fk_qid) references Questions(qid) ON UPDATE CASCADE ON DELETE CASCADE, 
